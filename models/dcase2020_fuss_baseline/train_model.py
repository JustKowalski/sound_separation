...
def main():
  ...
  hparams = model.get_model_hparams()#Model hyperparameters.
  hparams.sr = 16000.0
  ...
  meta = '/home/yinghaorong/dcase/dcase2020_fuss/baseline_train/2020-05-28_10-06-22/model.ckpt-544227.meta'
  model_save = '/home/yinghaorong/dcase/dcase2020_fuss/baseline_train/2020-05-28_10-06-22/model.ckpt-544227'
  with tf.Session() as sess:
    new_saver = tf.train.import_meta_graph(meta)
    new_saver.restore(sess,model_save)
