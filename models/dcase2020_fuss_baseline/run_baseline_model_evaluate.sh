...
OUTPUT_DIR=${MODEL_DIR}/baseline_evaluate_dia/${DATE}
mkdir -p ${OUTPUT_DIR}

#python3 ${SCRIPT_PATH}/evaluate.py -cp=${BASELINE_MODEL_DIR}/model.ckpt-25108 -mp=${BASELINE_MODEL_DIR}/inference.meta -dp=${DEV_DATA_DIR}/ssdata_reverb/eval_example_list.txt -op=${OUTPUT_DIR}
python3 ${SCRIPT_PATH}/evaluate.py -cp=${BASELINE_MODEL_DIR}/model.ckpt-25108  -dp=${DEV_DATA_DIR}/ssdata_reverb/eval_example_list.txt -op=${OUTPUT_DIR}
end=$(date +"%T")
