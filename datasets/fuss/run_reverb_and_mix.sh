...
#args：wirte_rir->Write tab separated source/rir lists in files for train/validate/eval.
#args:wirte_mix_info:read ssdata_reverb下的mix_info.txt
#args:read_sources->Reads an source/rir dict from a tab separated source/rir file.
...
#read_mix_info:Read a mix_info_file to form mix_info dictionary
